...
<section class="col-12 py-5 text-justify">
    ...
    <h3 class="text-center pb-4 pt-5">Custom WordPress Theme</h3>
    <p>All of the websites that we create have been built using tailor-made, custom WordPress themes which have been coded from scratch.</p>
    ...
    <h3 class="text-center pb-4 pt-5">Pre-Purpchased WordPress Themes</h3>
