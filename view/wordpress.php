...
<section class="col-12 py-5 text-justify">
    <h3 class="text-center pb-4">WordPress CMS</h3>  
    <p>WordPress CMS (Content Management System) adds a user-friendly administrative area to your website allowing you to easily login and update the content of your website at any time. You can effortlessly make textual, graphic or structural changes to the website in an instant without having to deal with or look at any of the complicated programming code. You will have full control over your website’s content.</p>
    <h3 class="text-center pb-4 pt-5">Custom WordPress Themes</h3>
    <p>We create custom, tailor-made WordPress themes, which we code from scratch.</p>
    ...
    <h3 class="text-center pb-4 pt-5">Pre-Purchased WordPress Themes</h3>
    <p>A pre-purchased WordPress theme is perfect for websites on a tight budget or deadline. It is an out-of-the-box design and layout that is ready to integrate into the WordPress CMS straight away. WordPress handles all of the content for you (posts, pages, comments etc.), while the theme transforms that content into a beautiful and clean layout for your audience to view. You will be able to make minor changes to the design to incorporate your company branding such as changing colours, adding a logo and adding imagery but if you are looking for a unique, custom design you should opt for a custom WordPress theme.</p>
    <h3 class="text-center pb-4 pt-5">WordPress Training</h3>
    <p>We offer customised WordPress training to ensure you and your team can effectively mange your website through the WordPress administrative area. We are happy to teach you over the phone, Skype or in person at your office. We can travel to any location in Ireland, whether you are in Dublin, Galway, Cork or anywhere else across the country.</p>
    <p>We can provide training for individuals or groups, and supply detailed notes on all of the topics covered for future reference. The training will cover everything you need to know to update your website independently, specific to your theme and custom functionality.</p>
</section>
</div>
<section class="row"> 
  <div class="col-lg-8 col-sm-12 py-3 border-top">
    <h6 class="nav-link float-left"><i class="fas fa-angle-left"></i><a class="nav-page" href="Jessie/logo">Logo Design</a></h6>
    <h6 class="nav-link float-right"><a class="nav-page" href="Jessie/content">Content Writing</a><i class="fas fa-angle-right"></i></h6>
  </div>
</section>
</main>
</div>