...
<section class="row"> 
  <div class="col-lg-8 col-sm-12 py-3 border-top">
    <h6 class="nav-link float-left"><i class="fas fa-angle-left"></i><a class="nav-page" href="Jessie/content">Content Writing</a></h6>
    <h6 class="nav-link float-right"><a class="nav-page" href="Jessie/logo">Logo Design</a><i class="fas fa-angle-right"></i></h6>
  </div>
</section>
</main>
</div>
